    ...
    <section className="relative py-32 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Partner with Noor Educational System
          </motion.h1>
          ...
          >
            Bring the proven Noor model to your community. Comprehensive support, established brand, and a mission that matters.
          </motion.p>
          ...
          >
            {[
              { label: "Years Proven", value: "25+" },
              { label: "Replicable Model", value: "Yes" },
              { label: "Full Support", value: "Included" },
            ].map((stat, index) => (
